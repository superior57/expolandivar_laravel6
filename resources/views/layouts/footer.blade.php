<!-- Footer Area-->
<footer class="footer-area footer2 pt-5 py-2">
  <div class="container">
      ...
      <div class="col-12 col-sm-10 col-lg-3">
        <div class="footer-widget-area mb-4"><a class="d-block mb-4" href="{{ url('/') }}"><img src="{{ asset('img/logo-white.png') }}" alt=""></a>
          ...
          <div class="d-flex justify-content-between">
            ...
            <div class="d-flex">
              <p class="m-auto">PBX 2426-2626</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 pl-md-30">
        <div class="footer-widget-area mb-4">
          <ul>
            ...
            <li><a href="#" target="_blank">FAQ general</a></li>
            <li><a href="#" target="_blank">Siguientes Pasos</a></li>
          </ul>
        </div>
      </div>
      <!-- Footer Widget Area-->
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 ">
        <div class="footer-widget-area mb-4">
          <ul>
            ...
            <li><a href="#" target="_blank">Facultad de Ciencias de la Salud</a></li>
            <li><a href="#" target="_blank">Facultad de Humanidades</a></li>
            <li><a href="#" target="_blank">Facultad de Teología</a></li>
          </ul>
        </div>
      </div>
      <!-- Footer Widget Area-->
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 ">
        <div class="footer-widget-area mb-4">
          <ul>
            ...
            <li><a href="#" target="_blank">Facultad de Ciencias Ciencias Jurídicas y Sociales</a></li>
            <li><a href="#" target="_blank">Facultad de Ciencias Ciencias Jurídicas y Políticas</a></li>
            <li><a href="#" target="_blank">Todas las Facultades</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 col-md-6">
        <p>
          © 2020 Universdad Rafael Landívar. Todos los derechos reservados
        </p>
      </div>
      <div class="col-12 col-md-6 text-end">
        <p>
          Aviso de privacidad de información
        </p>
      </div>
    </div>
  </div>
